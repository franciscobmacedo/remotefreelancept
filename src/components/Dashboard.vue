  ...
  <div class="grid grid-cols-1 md:grid-cols-2 md:space-x-10 mt-5 md:mt-5 mb-20">
    <div>
      ...
      <div class="flex ml-3 md:ml-0 justify-start items-center mt-2 space-x-4">
        ...
        <AdjustCounter v-model:value="ssDiscountPosition" :min="0" :max="store.ssDiscountChoices.length - 1"
          data-cy="ss-discount">
          {{ ssDiscountDisplay }}
        </AdjustCounter>
        <InfoButton
      ...
      <div class="
        ...
        <SwitchButton label="Are you within the first 12 months of starting your activity?"
          :modelValue="store.ssFirstYear" @update:modelValue="store.setSsFirstYear" 
      ...
      <div class="
          ...
          md:space-x-4
        ">
        <SwitchButton label="Are you in your first fiscal year of activity?" :modelValue="store.firstYear"
          @update:modelValue="setFirstYear" 
          data-cy="first-year"
          />
        <InfoButton
      ...
      <div class="
          ...
          md:space-x-4
        ">
        <SwitchButton label="Are you in your second fiscal year of activity?"
          :modelValue="store.secondYear" @update:modelValue="setSecondYear"
      ...
      <div class="
          ...
          md:space-x-4
        ">
        <SwitchButton label="Are you eligible to be in the NHR/RNH?" :modelValue="store.rnh"
          @update:modelValue="store.setRnh" 
          data-cy="rnh"
          />
        <InfoButton
...
watch(
  ...
  (newPosition) => {
    store.setSsDiscount(store.ssDiscountChoices[newPosition]);
  },
);
